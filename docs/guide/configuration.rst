...
This guide describes the service configuration options. These options can be provided in a service constructor or to the ``LT\eBaySDK\Sdk`` class.
...
.. code-block:: php
    ...
    use LT\eBaySDK\Shopping\Services\ShoppingService;
...
.. code-block:: php
    ...
    use LT\eBaySDK\Trading\Types;
    use LT\eBaySDK\Trading\Services;
...
.. code-block:: php
    ...
    use LT\eBaySDK\Browse\Services\BrowseService;
...
:Type: ``array|LT\eBaySDK\Credentials\CredentialsInterface|callable``
...
You can also pass an instance of the ``LT\eBaySDK\Credentials\CredentialsInterface`` interface.
