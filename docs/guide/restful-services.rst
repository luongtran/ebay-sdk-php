...
.. code-block:: php
    ...
    <?php
    use \LT\eBaySDK\Browse\Types;

    $request = new Types\GetItemRestRequest();

    /**
     * $response will be of the type LT\eBaySDK\Browse\Types\GetItemRestResponse
     */
...
The SDK provides some support for generating the OAuth tokens needed by the RESTful services. This is provided via the ``\LT\eBaySDK\OAuth\Services\OAuthService`` class.


.. code-block:: php

    use \LT\eBaySDK\OAuth\Services;
    use \LT\eBaySDK\OAuth\Types;
