<?php
namespace LT\eBaySDK\Parser\Test;

use LT\eBaySDK\Parser\JsonParser;

class JsonParserTest extends \PHPUnit_Framework_TestCase
{
    public function testCanParseJson()
    {
        $obj = new \LT\eBaySDK\Test\Mocks\ComplexClass();
        $json = file_get_contents(__DIR__.'/../Mocks/ResponseWithUnknownProperties.json');
        JsonParser::parseAndAssignProperties($obj, $json);

        $this->assertInstanceOf('\LT\eBaySDK\Test\Mocks\ComplexClass', $obj);
        ...
        $this->assertEquals('bar', $obj->strings[1]);
        $this->assertInstanceOf('\LT\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[0]);
        $this->assertEquals(888, $obj->simpleClasses[0]->integer);
        $this->assertInstanceOf('\LT\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[1]);
