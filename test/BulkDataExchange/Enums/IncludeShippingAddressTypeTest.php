...
use LT\eBaySDK\BulkDataExchange\Enums\IncludeShippingAddressType;
...
class IncludeShippingAddressTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\BulkDataExchange\Enums\IncludeShippingAddressType', $this->obj);
    }
}
