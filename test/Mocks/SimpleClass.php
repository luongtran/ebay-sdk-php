...
class SimpleClass extends \LT\eBaySDK\Types\BaseType
{
    private static $propertyTypes = [
        ...
        'base64BinaryType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\Base64BinaryType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'base64BinaryType'
        ],
        'booleanType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\BooleanType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'booleanType'
        ],
        'decimalType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\DecimalType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'decimalType'
        ],
        'doubleType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\DoubleType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'doubleType'
        ],
        'integerType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\IntegerType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'integerType'
        ],
        'stringType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\StringType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'stringType'
        ],
        'tokenType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\TokenType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'tokenType'
        ],
        'uriType' => [
            'type' => 'LT\eBaySDK\Test\Mocks\URIType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'uriType'
        ],
