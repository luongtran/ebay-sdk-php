...
use LT\eBaySDK\MerchantData\Enums\TransactionReferenceCodeType;
...
class TransactionReferenceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\TransactionReferenceCodeType', $this->obj);
    }
}
