...
use LT\eBaySDK\MerchantData\Enums\ReasonHideFromSearchCodeType;
...
class ReasonHideFromSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\ReasonHideFromSearchCodeType', $this->obj);
    }
}
