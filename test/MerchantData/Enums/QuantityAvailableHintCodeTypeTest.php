...
use LT\eBaySDK\MerchantData\Enums\QuantityAvailableHintCodeType;
...
class QuantityAvailableHintCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\QuantityAvailableHintCodeType', $this->obj);
    }
}
