...
use LT\eBaySDK\MerchantData\Enums\BuyerProtectionSourceCodeType;
...
class BuyerProtectionSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\BuyerProtectionSourceCodeType', $this->obj);
    }
}
