...
use LT\eBaySDK\MerchantData\Enums\SellerGuaranteeLevelCodeType;
...
class SellerGuaranteeLevelCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\SellerGuaranteeLevelCodeType', $this->obj);
    }
}
