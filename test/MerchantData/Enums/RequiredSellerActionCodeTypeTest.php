...
use LT\eBaySDK\MerchantData\Enums\RequiredSellerActionCodeType;
...
class RequiredSellerActionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\MerchantData\Enums\RequiredSellerActionCodeType', $this->obj);
    }
}
