...
use LT\eBaySDK\Fulfillment\Enums\LineItemFulfillmentStatusEnum;
...
class LineItemFulfillmentStatusEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Fulfillment\Enums\LineItemFulfillmentStatusEnum', $this->obj);
    }
}
