...
use LT\eBaySDK\Test\Mocks\Base64BinaryType;
use LT\eBaySDK\Test\Mocks\BooleanType;
use LT\eBaySDK\Test\Mocks\DecimalType;
use LT\eBaySDK\Test\Mocks\DoubleType;
use LT\eBaySDK\Test\Mocks\IntegerType;
use LT\eBaySDK\Test\Mocks\StringType;
use LT\eBaySDK\Test\Mocks\TokenType;
use LT\eBaySDK\Test\Mocks\URIType;
...
class SimpleClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Test\Mocks\SimpleClass', $this->obj);
    }
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf('\LT\eBaySDK\Test\Mocks\SimpleClass', $this->obj->SimpleClass);

        $this->assertEquals(0, count($this->obj->strings));
        $this->assertInstanceOf('\LT\eBaySDK\Types\RepeatableType', $this->obj->strings);
        ...
        $this->assertInstanceOf('\LT\eBaySDK\Types\RepeatableType', $this->obj->integers);
        ...
        $this->assertInstanceOf('\LT\eBaySDK\Types\RepeatableType', $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    {
        $this->setExpectedException('\LT\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property foo');
    ...
    {
        $this->setExpectedException('\LT\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integer. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\LT\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\LT\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected LT\eBaySDK\Types\RepeatableType but got integer');
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = 'LT\eBaySDK\Test\Mocks\SimpleClass';
