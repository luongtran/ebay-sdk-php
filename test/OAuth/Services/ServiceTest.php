<?php
namespace LT\eBaySDK\Test\OAuth\Services;

use LT\eBaySDK\Test\TestTraits\ManageEnv;
use LT\eBaySDK\OAuth\Services\OAuthService;
use LT\eBaySDK\Test\Mocks\HttpOAuthHandler;
...
class ServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResponseIsReturned()
    {
        ...
        $this->assertInstanceOf('\LT\eBaySDK\OAuth\Types\GetAppTokenRestResponse', $r);
