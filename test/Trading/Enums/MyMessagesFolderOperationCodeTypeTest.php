...
use LT\eBaySDK\Trading\Enums\MyMessagesFolderOperationCodeType;
...
class MyMessagesFolderOperationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Trading\Enums\MyMessagesFolderOperationCodeType', $this->obj);
    }
}
