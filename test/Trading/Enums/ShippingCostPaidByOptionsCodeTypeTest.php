...
use LT\eBaySDK\Trading\Enums\ShippingCostPaidByOptionsCodeType;
...
class ShippingCostPaidByOptionsCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Trading\Enums\ShippingCostPaidByOptionsCodeType', $this->obj);
    }
}
