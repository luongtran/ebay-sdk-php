...
use LT\eBaySDK\Trading\Enums\SMSSubscriptionUserStatusCodeType;
...
class SMSSubscriptionUserStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Trading\Enums\SMSSubscriptionUserStatusCodeType', $this->obj);
    }
}
