...
use LT\eBaySDK\Trading\Enums\SecondChanceOfferDurationCodeType;
...
class SecondChanceOfferDurationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Trading\Enums\SecondChanceOfferDurationCodeType', $this->obj);
    }
}
