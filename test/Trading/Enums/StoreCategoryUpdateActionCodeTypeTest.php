...
use LT\eBaySDK\Trading\Enums\StoreCategoryUpdateActionCodeType;
...
class StoreCategoryUpdateActionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Trading\Enums\StoreCategoryUpdateActionCodeType', $this->obj);
    }
}
