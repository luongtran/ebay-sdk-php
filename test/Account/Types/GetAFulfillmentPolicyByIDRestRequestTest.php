...
use LT\eBaySDK\Account\Types\GetAFulfillmentPolicyByIDRestRequest;
...
class GetAFulfillmentPolicyByIDRestRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\LT\eBaySDK\Account\Types\GetAFulfillmentPolicyByIDRestRequest', $this->obj);
    }
