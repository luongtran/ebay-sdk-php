<?php
namespace LT\eBaySDK\Taxonomy\Services;

/**
 * Base class for the Taxonomy service.
 */
class TaxonomyBaseService extends \LT\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \LT\eBaySDK\Taxonomy\Services\TaxonomyService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
