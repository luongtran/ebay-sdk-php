...
/**
 *
 * @property \LT\eBaySDK\Account\Types\ErrorDetailV3[] $errors
 * @property \LT\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class GetFulfillmentPoliciesByMarketplaceRestResponse extends \LT\eBaySDK\Account\Types\FulfillmentPolicyResponse
{
    use StatusCodeTrait;
