 ...
 * @property \LT\eBaySDK\Account\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \LT\eBaySDK\Account\Enums\ReturnMethodEnum $returnMethod
 * @property \LT\eBaySDK\Account\Types\TimeDuration $returnPeriod
 * @property string $returnPolicyId
 * @property boolean $returnsAccepted
 * @property \LT\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 * @property \LT\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class SetReturnPolicyResponse extends \LT\eBaySDK\Types\BaseType
{
    /**
