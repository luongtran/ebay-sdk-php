...
/**
 *
 * @property \LT\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \LT\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \LT\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \LT\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \LT\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \LT\eBaySDK\Types\BaseType
{
    /**
