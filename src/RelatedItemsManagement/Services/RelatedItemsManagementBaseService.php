 ...
 */
class RelatedItemsManagementBaseService extends \LT\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \LT\eBaySDK\RelatedItemsManagement\Services\RelatedItemsManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
