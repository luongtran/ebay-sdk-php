 ...
 * @property \LT\eBaySDK\Catalog\Enums\ChangeRequestStatus $changeRequestStatus
 * @property \LT\eBaySDK\Catalog\Enums\ChangeRequestType $changeRequestType
 * @property string $creationDate
 * @property string $expectedCompletionDate
 * @property \LT\eBaySDK\Catalog\Types\ProcessResolution $processResolution
 * @property string $processStatusMessage
 * @property string $reasonForChangeRequest
 * @property string $referenceId
 * @property \LT\eBaySDK\Catalog\Enums\ReferenceType $referenceType
 * @property string $resolutionDate
 * @property \LT\eBaySDK\Catalog\Types\SuggestedProduct $suggestedProduct
 */
class ChangeRequest extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'processResolution' => [
            'type' => 'LT\eBaySDK\Catalog\Types\ProcessResolution',
            'repeatable' => false,
            'attribute' => false,
        ...
        'suggestedProduct' => [
            'type' => 'LT\eBaySDK\Catalog\Types\SuggestedProduct',
            'repeatable' => false,
            'attribute' => false,
