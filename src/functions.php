...
use LT\eBaySDK\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'LT\eBaySDK\Credentials\CredentialsInterface, an associative '
...
{
    if (\LT\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
