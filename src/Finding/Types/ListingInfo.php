 ...
 * @property \LT\eBaySDK\Finding\Types\Amount $buyItNowPrice
 * @property \LT\eBaySDK\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \LT\eBaySDK\Types\BaseType
{
    /**
