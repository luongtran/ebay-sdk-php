 ...
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $actualDeliveryDate
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $actualShipDate
 * @property string $carrierEnum
 * @property integer $carrierId
 * @property string $carrierName
 * @property string $carrierUsed
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $deliveryDate
 * @property \LT\eBaySDK\PostOrder\Enums\TrackingStatusEnum $deliveryStatus
 * @property \LT\eBaySDK\PostOrder\Types\ReturnAddressType $destinationAddress
 * @property string $errorCode
 * @property string $labelAvailableUntilDate
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $labelDate
 * @property string $labelId
 * @property boolean $labelPrintExpired
 * @property boolean $labelVoidExpired
 * @property boolean $markAsReceived
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $maxDeliveryEstimate
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $minDeliveryEstimate
 * @property \LT\eBaySDK\PostOrder\Types\ReturnAddressType $originAddress
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $shipDate
 * @property string $shipmentId
 * @property string $shippedBy
 * @property \LT\eBaySDK\PostOrder\Enums\ShippingMethodEnum $shippingMethod
 * @property string $trackingNumber
 */
class ShipmentTrackingType extends \LT\eBaySDK\Types\BaseType
{
    /**
