...
/**
 *
 * @property \LT\eBaySDK\PostOrder\Types\DateTime $actionDate
 * @property string $activityParty
 * @property \LT\eBaySDK\PostOrder\Enums\CancelActivityTypeEnum $activityType
 * @property string $cancelStateFrom
 * @property string $cancelStateTo
 * @property string $cancelStatetateTo
 */
class CancelActivityHistory extends \LT\eBaySDK\Types\BaseType
{
    /**
