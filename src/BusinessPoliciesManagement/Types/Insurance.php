...
/**
 *
 * @property \LT\eBaySDK\BusinessPoliciesManagement\Types\Amount $domesticInsuranceFee
 * @property string $domesticInsuranceOption
 * @property string $intlInsuranceOption
 * @property \LT\eBaySDK\BusinessPoliciesManagement\Types\Amount $intlInsuranceFee
 */
class Insurance extends \LT\eBaySDK\Types\BaseType
{
    /**
