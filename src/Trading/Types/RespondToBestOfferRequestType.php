 ...
 * @property \LT\eBaySDK\Trading\Enums\BestOfferActionCodeType $Action
 * @property string $SellerResponse
 * @property \LT\eBaySDK\Trading\Types\AmountType $CounterOfferPrice
 * @property integer $CounterOfferQuantity
 */
class RespondToBestOfferRequestType extends \LT\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
