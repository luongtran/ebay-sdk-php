 ...
 * @property \LT\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \LT\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
