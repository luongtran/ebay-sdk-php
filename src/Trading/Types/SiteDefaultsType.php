...
/**
 *
 * @property \LT\eBaySDK\Trading\Types\ListingDurationReferenceType[] $ListingDuration
 ...
 * @property \LT\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $AdFormatEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $ClassifiedAdPaymentMethodEnabled
 * @property boolean $ClassifiedAdShippingMethodEnabled
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $ClassifiedAdBestOfferEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\ItemSpecificsEnabledCodeType $ItemSpecificsEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\INEscrowWorkflowTimelineCodeType $INEscrowWorkflowTimeline
 * @property \LT\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType $GalleryFeaturedDurations
 * @property boolean $PayPalRequired
 * @property \LT\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $eBayMotorsProAdFormatEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $eBayMotorsProBestOfferEnabled
 * @property boolean $eBayMotorsProAutoAcceptEnabled
 * @property boolean $eBayMotorsProAutoDeclineEnabled
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $eBayMotorsProPaymentMethodCheckOutEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $LocalMarketAdFormatEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $LocalMarketBestOfferEnabled
 * @property boolean $LocalMarketAutoAcceptEnabled
 * @property boolean $LocalMarketAutoDeclineEnabled
 * @property \LT\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $LocalMarketPaymentMethodCheckOutEnabled
 ...
 * @property \LT\eBaySDK\Trading\Enums\GeographicExposureCodeType $SpecialitySubscription
 * @property \LT\eBaySDK\Trading\Enums\GeographicExposureCodeType $RegularSubscription
 * @property \LT\eBaySDK\Trading\Enums\GeographicExposureCodeType $PremiumSubscription
 * @property \LT\eBaySDK\Trading\Enums\GeographicExposureCodeType $NonSubscription
 ...
 * @property \LT\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType $StoreOwnerExtendedListingDurations
 * @property boolean $ReturnPolicyEnabled
 * @property boolean $HandlingTimeEnabled
 * @property \LT\eBaySDK\Trading\Types\AmountType $MaxFlatShippingCost
 * @property boolean $MaxFlatShippingCostCBTExempt
 * @property \LT\eBaySDK\Trading\Types\AmountType $Group1MaxFlatShippingCost
 * @property \LT\eBaySDK\Trading\Types\AmountType $Group2MaxFlatShippingCost
 * @property \LT\eBaySDK\Trading\Types\AmountType $Group3MaxFlatShippingCost
 * @property \LT\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType[] $PaymentMethod
 * @property boolean $VariationsEnabled
 * @property boolean $FreeGalleryPlusEnabled
 * @property boolean $FreePicturePackEnabled
 * @property \LT\eBaySDK\Trading\Enums\ItemCompatibilityEnabledCodeType $ItemCompatibilityEnabled
 * @property integer $MinItemCompatibility
 * @property integer $MaxItemCompatibility
 * @property \LT\eBaySDK\Trading\Enums\ConditionEnabledCodeType $ConditionEnabled
 * @property \LT\eBaySDK\Trading\Types\ConditionValuesType $ConditionValues
 * @property boolean $ValueCategory
 * @property \LT\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType $ProductCreationEnabled
 * @property \LT\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $EANEnabled
 * @property \LT\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $ISBNEnabled
 * @property \LT\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $UPCEnabled
 * @property integer $MaxGranularFitmentCount
 * @property string $CompatibleVehicleType
 * @property \LT\eBaySDK\Trading\Enums\PaymentOptionsGroupEnabledCodeType $PaymentOptionsGroup
 * @property \LT\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ShippingProfileCategoryGroup
 * @property \LT\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $PaymentProfileCategoryGroup
 * @property \LT\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ReturnPolicyProfileCategoryGroup
 ...
 * @property \LT\eBaySDK\Trading\Enums\ProductRequiredEnabledCodeType $ProductRequiredEnabled
 */
class SiteDefaultsType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'ListingDuration' => [
            'type' => 'LT\eBaySDK\Trading\Types\ListingDurationReferenceType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'GalleryFeaturedDurations' => [
            'type' => 'LT\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'StoreOwnerExtendedListingDurations' => [
            'type' => 'LT\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ConditionValues' => [
            'type' => 'LT\eBaySDK\Trading\Types\ConditionValuesType',
            'repeatable' => false,
            'attribute' => false,
