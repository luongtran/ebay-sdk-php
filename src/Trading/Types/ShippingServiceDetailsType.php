 ...
 * @property \LT\eBaySDK\Trading\Enums\ShippingServiceCodeType $ShippingServiceCode
 * @property \LT\eBaySDK\Trading\Enums\ShippingTypeCodeType[] $ServiceType
 ...
 * @property \LT\eBaySDK\Trading\Enums\ShippingCarrierCodeType[] $ShippingCarrier
 * @property boolean $CODService
 * @property \LT\eBaySDK\Trading\Types\AnnouncementMessageType[] $DeprecationDetails
 * @property integer $MappedToShippingServiceID
 * @property string $CostGroupFlat
 * @property \LT\eBaySDK\Trading\Types\ShippingServicePackageDetailsType[] $ShippingServicePackageDetails
 * @property boolean $WeightRequired
 * @property string $DetailVersion
 * @property \DateTime $UpdateTime
 * @property string $ShippingCategory
 */
class ShippingServiceDetailsType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'DeprecationDetails' => [
            'type' => 'LT\eBaySDK\Trading\Types\AnnouncementMessageType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShippingServicePackageDetails' => [
            'type' => 'LT\eBaySDK\Trading\Types\ShippingServicePackageDetailsType',
            'repeatable' => true,
            'attribute' => false,
