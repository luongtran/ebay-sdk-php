...
class OAuthService
{
    ...
    private static $operations = [
        'getUserToken' => [
            ...
            'responseClass' => '\LT\eBaySDK\OAuth\Types\GetUserTokenRestResponse',
            'params' => [
            ]
        ],
        'refreshUserToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\LT\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse',
            'params' => [
            ]
        ],
        'getAppToken' => [
            'method' => 'POST',
            'resource' => 'oauth2/token',
            'responseClass' => '\LT\eBaySDK\OAuth\Types\GetAppTokenRestResponse',
            'params' => [
            ]
        ]
    ];
    ...
    /**
     * @var \LT\eBaySDK\UriResolver Resolves uri parameters.
     */
    private $uriResolver;
    ...
    public static function getConfigDefinitions()
    {
        return [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \LT\eBaySDK\OAuth\Services\OAuthService::API_VERSION,
                'required' => true
            ],
            'profile' => [
                'valid' => ['string'],
    ...
    /**
     * @param \LT\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request
     * @return \LT\eBaySDK\OAuth\Types\GetUserTokenRestResponse
     */
    public function getUserToken(\LT\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
     ...
     */
    public function getUserTokenAsync(\LT\eBaySDK\OAuth\Types\GetUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \LT\eBaySDK\OAuth\Types\GetUserTokenRestRequest();
        }
    ...
    /**
     * @param \LT\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request
     * @return \LT\eBaySDK\OAuth\Types\RefreshUserTokenRestResponse
     */
    public function refreshUserToken(\LT\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest $request)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshUserTokenAsync(\LT\eBaySDK\OAuth\Types\refreshUserTokenRestRequest $request)
    {
        if (!$request) {
            $request = new \LT\eBaySDK\OAuth\Types\RefreshUserTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
    ...
    /**
     * @param \LT\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request
     * @return \LT\eBaySDK\OAuth\Types\GetAppTokenRestResponse
     */
    public function getAppToken(\LT\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAppTokenAsync(\LT\eBaySDK\OAuth\Types\GetAppTokenRestRequest $request = null)
    {
        if (!$request) {
            $request = new \LT\eBaySDK\OAuth\Types\GetAppTokenRestRequest();
        }
        if (!isset($request->grant_type)) {
     ...
     */
    private function callOperationAsync($name, \LT\eBaySDK\Types\BaseType $request = null)
    {
