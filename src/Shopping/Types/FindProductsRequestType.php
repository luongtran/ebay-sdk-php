 ...
 * @property \LT\eBaySDK\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \LT\eBaySDK\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \LT\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
