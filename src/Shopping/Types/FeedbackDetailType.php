 ...
 * @property \LT\eBaySDK\Shopping\Enums\CommentTypeCodeType $CommentType
 * @property string $FeedbackResponse
 * @property string $FollowUp
 * @property string $ItemID
 * @property \LT\eBaySDK\Shopping\Enums\TradingRoleCodeType $Role
 * @property string $ItemTitle
 * @property \LT\eBaySDK\Shopping\Types\AmountType $ItemPrice
