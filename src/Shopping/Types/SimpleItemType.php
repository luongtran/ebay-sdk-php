 ...
 * @property \LT\eBaySDK\Shopping\Types\AmountType $BuyItNowPrice
 * @property string $Description
 * @property string $ItemID
 * @property boolean $BuyItNowAvailable
 * @property \LT\eBaySDK\Shopping\Types\AmountType $ConvertedBuyItNowPrice
 * @property \DateTime $EndTime
 * @property \DateTime $StartTime
 * @property string $ViewItemURLForNaturalSearch
 * @property \LT\eBaySDK\Shopping\Enums\ListingTypeCodeType $ListingType
 * @property string $Location
 * @property \LT\eBaySDK\Shopping\Enums\BuyerPaymentMethodCodeType[] $PaymentMethods
 ...
 * @property \LT\eBaySDK\Shopping\Types\SimpleUserType $Seller
 * @property integer $BidCount
 * @property \LT\eBaySDK\Shopping\Types\AmountType $ConvertedCurrentPrice
 * @property \LT\eBaySDK\Shopping\Types\AmountType $CurrentPrice
 * @property \LT\eBaySDK\Shopping\Types\SimpleUserType $HighBidder
 * @property \LT\eBaySDK\Shopping\Enums\ListingStatusCodeType $ListingStatus
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property string[] $ShipToLocations
 * @property \LT\eBaySDK\Shopping\Enums\SiteCodeType $Site
 * @property string $TimeLeft
 * @property string $Title
 * @property \LT\eBaySDK\Shopping\Types\ShippingCostSummaryType $ShippingCostSummary
 * @property \LT\eBaySDK\Shopping\Types\NameValueListArrayType $ItemSpecifics
 ...
 * @property \LT\eBaySDK\Shopping\Types\CharityType $Charity
 * @property \LT\eBaySDK\Shopping\Types\StorefrontType $Storefront
 * @property \LT\eBaySDK\Shopping\Enums\CountryCodeType $Country
 * @property \LT\eBaySDK\Shopping\Enums\HalfItemConditionCodeType $HalfItemCondition
 * @property string $SellerComments
 * @property \LT\eBaySDK\Shopping\Types\ReturnPolicyType $ReturnPolicy
 * @property \LT\eBaySDK\Shopping\Types\AmountType $MinimumToBid
 * @property \LT\eBaySDK\Shopping\Types\ProductIDType $ProductID
 * @property boolean $AutoPay
 * @property \LT\eBaySDK\Shopping\Types\BusinessSellerDetailsType $BusinessSellerDetails
 * @property \LT\eBaySDK\Shopping\Enums\SiteCodeType[] $PaymentAllowedSite
 * @property boolean $IntegratedMerchantCreditCardEnabled
 * @property \LT\eBaySDK\Shopping\Types\VariationsType $Variations
 * @property integer $HandlingTime
 * @property integer $LotSize
 * @property integer $ConditionID
 * @property string $ConditionDisplayName
 * @property \LT\eBaySDK\Shopping\Enums\QuantityAvailableHintCodeType $QuantityAvailableHint
 * @property integer $QuantityThreshold
 * @property \LT\eBaySDK\Shopping\Types\DiscountPriceInfoType $DiscountPriceInfo
 * @property string[] $ExcludeShipToLocation
 * @property boolean $TopRatedListing
 * @property string $VhrUrl
 * @property boolean $VhrAvailable
 * @property \LT\eBaySDK\Shopping\Types\QuantityInfo $QuantityInfo
 * @property \LT\eBaySDK\Shopping\Types\UnitInfoType $UnitInfo
 * @property boolean $GlobalShipping
 * @property string $ConditionDescription
 * @property integer $ItemCompatibilityCount
 * @property \LT\eBaySDK\Shopping\Types\ItemCompatibilityListType $ItemCompatibilityList
 ...
 */
class SimpleItemType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'ItemSpecifics' => [
            'type' => 'LT\eBaySDK\Shopping\Types\NameValueListArrayType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Charity' => [
            'type' => 'LT\eBaySDK\Shopping\Types\CharityType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'Charity'
        ],
        'Storefront' => [
            'type' => 'LT\eBaySDK\Shopping\Types\StorefrontType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ReturnPolicy' => [
            'type' => 'LT\eBaySDK\Shopping\Types\ReturnPolicyType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ProductID' => [
            'type' => 'LT\eBaySDK\Shopping\Types\ProductIDType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BusinessSellerDetails' => [
            'type' => 'LT\eBaySDK\Shopping\Types\BusinessSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Variations' => [
            'type' => 'LT\eBaySDK\Shopping\Types\VariationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'DiscountPriceInfo' => [
            'type' => 'LT\eBaySDK\Shopping\Types\DiscountPriceInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'QuantityInfo' => [
            'type' => 'LT\eBaySDK\Shopping\Types\QuantityInfo',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'QuantityInfo'
        ],
        'UnitInfo' => [
            'type' => 'LT\eBaySDK\Shopping\Types\UnitInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ItemCompatibilityList' => [
            'type' => 'LT\eBaySDK\Shopping\Types\ItemCompatibilityListType',
            'repeatable' => false,
            'attribute' => false,
