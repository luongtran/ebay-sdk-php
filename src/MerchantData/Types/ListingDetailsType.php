 ...
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $ConvertedBuyItNowPrice
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $ConvertedStartPrice
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $ConvertedReservePrice
 ...
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \LT\eBaySDK\MerchantData\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \LT\eBaySDK\Types\BaseType
{
    /**
