 ...
 * @property string $UPC
 * @property string $EAN
 * @property \LT\eBaySDK\MerchantData\Types\BrandMPNType $BrandMPN
 * @property \LT\eBaySDK\MerchantData\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
