...
/**
 *
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $ConvertedMaxBid
 * @property \LT\eBaySDK\MerchantData\Types\AmountType $MaxBid
 * @property integer $QuantityBid
 * @property integer $QuantityWon
 * @property boolean $Winning
 */
class BiddingDetailsType extends \LT\eBaySDK\Types\BaseType
{
    /**
