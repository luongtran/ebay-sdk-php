 ...
 * @property \LT\eBaySDK\MerchantData\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \LT\eBaySDK\MerchantData\Enums\SellerLevelCodeType $SellerLevel
 * @property \LT\eBaySDK\MerchantData\Types\AddressType $SellerPaymentAddress
 * @property \LT\eBaySDK\MerchantData\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \LT\eBaySDK\MerchantData\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \LT\eBaySDK\MerchantData\Enums\SiteCodeType $StoreSite
 * @property \LT\eBaySDK\MerchantData\Enums\SellerPaymentMethodCodeType $PaymentMethod
 * @property boolean $CharityRegistered
 * @property boolean $SafePaymentExempt
 * @property integer $PaisaPayEscrowEMIStatus
 * @property \LT\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \LT\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \LT\eBaySDK\MerchantData\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \LT\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \LT\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
 * @property boolean $DomesticRateTable
 */
class SellerType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
