 ...
 * @property \LT\eBaySDK\MerchantData\Enums\CountryCodeType $PhoneCountryCode
 * @property string $PhoneCountryPrefix
 * @property string $PhoneAreaOrCityCode
 * @property string $PhoneLocalNumber
 * @property \LT\eBaySDK\MerchantData\Enums\CountryCodeType $Phone2CountryCode
 * @property string $Phone2CountryPrefix
 * @property string $Phone2AreaOrCityCode
 * @property string $Phone2LocalNumber
 * @property string $PostalCode
 * @property string $AddressID
 * @property \LT\eBaySDK\MerchantData\Enums\AddressOwnerCodeType $AddressOwner
 ...
 * @property \LT\eBaySDK\MerchantData\Enums\AddressUsageCodeType $AddressUsage
 * @property string $ReferenceID
 * @property \LT\eBaySDK\MerchantData\Types\AddressAttributeType[] $AddressAttribute
 */
class AddressType extends \LT\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'AddressAttribute' => [
            'type' => 'LT\eBaySDK\MerchantData\Types\AddressAttributeType',
            'repeatable' => true,
            'attribute' => false,
