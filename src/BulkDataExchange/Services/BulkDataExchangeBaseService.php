 ...
 */
class BulkDataExchangeBaseService extends \LT\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \LT\eBaySDK\BulkDataExchange\Services\BulkDataExchangeService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
