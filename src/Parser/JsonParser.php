...
{
    /**
     * @param mixed A PHP object derived from LT\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\LT\eBaySDK\Types\BaseType $object, array $properties)
    {
